...
export function LanguageProvider({ children, initialLocale = "en" }) {
  ...
  useEffect(() => {
    ...
    // First visit - detect language from browser (client-side)
    // This is more reliable than SSR detection through proxy/cache
    const browserLang = navigator.language || navigator.userLanguage || "";
    const detectedLocale = browserLang.toLowerCase().startsWith("ru")
      ? "ru"
      : "en";
