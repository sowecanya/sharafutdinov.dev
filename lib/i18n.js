...
export function LanguageProvider({ children, initialLocale = "en" }) {
  ...
  useEffect(() => {
    ...
    // First visit - save detected locale (from initialLocale prop)
    // This persists the auto-detected locale for future visits
    if (initialLocale && (initialLocale === "en" || initialLocale === "ru")) {
